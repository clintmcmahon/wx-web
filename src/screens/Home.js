                ...
                <Col xs={12} className="form-group">
                    ...
                    <Row>
                        <Col xs={12} className="mt-4">
                            <DailyRecords selectedStation={state.location.station ? state.location.station : null} selectedDate={selectedDate} />
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={12} className="mt-4">
                            <MonthNormalObserved selectedStation={state.location.station ? state.location.station: null} selectedDate={selectedDate} />
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={12} className="mt-4">
                            <NormalSnowPrecipitation selectedStation={state.location.station ? state.location.station : null} selectedDate={selectedDate} />
                        </Col>
                    </Row>
                </Col>
            </Row>
